...
const pb_first_child = document.getElementById('li1');
const pb_second_child = document.getElementById('li2');
const pb_last_child = document.getElementById('li3');
...
secondButton[1].addEventListener('click', (evt) => {
	evt.preventDefault();
	if (!veriffname(form.fname))
		return (null);
	if (!veriflname(form.lname))
		return (null);
	fields[1].classList.forEach((className) => {
		if (className === 'isVisible') {

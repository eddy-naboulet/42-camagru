<form id="msform" method="post" action="php/create_user_server.php">
	<ul id="progressbar">
		<li id="li1" class="active">Account Setup</li>
		<li id="li2" class="">Personal Details</li>
		<li id="li3" class="">Profile Picture</li>
	</ul>
	...
	<div class="isInactive isField" >
		...
		<input type="text" name="fname" onInput="veriffname(this)" placeholder="First Name" />
		<input type="text" name="lname" onInput="veriflname(this)" placeholder="Last Name" />
